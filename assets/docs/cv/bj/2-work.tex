...
%     APP
    ...
    B2B%
        ...
        \textperiodcentered $ $
        Launched a UX research initiative that drove product discovery, informed roadmap decisions, and improved user satisfaction
...
\textperiodcentered $ $ Proven results: Enabled the first 50+ active users to platform  \\
...
\textperiodcentered $ $
% Partnered with business development,
% legal, %distribution and
% sales, and
% Integrations with third-party service providers, APIs, % (Eveara, Idenfy, DexHunter, Charlie3)
  Streamlining the signup [KYC], distribution and payment experience % \\
} \\
...
%      \textperiodcentered $ $ Talking with stakeholders, getting requirements, strategy, follow up \\  %
     \textperiodcentered $ $ Proven results: Improved QA and sales for Truck Dealership site
%      [Automotive]
%      and CRM
%      Experience]
     \\
...
% · Implementing CRM improvements and features for Truck Dealer CRM
...
% % % % % % % % % % % % % % % % % % %
%         \textperiodcentered $ $ Built big data workflow (knime) with testing performance (e2e) \\
%         \textperiodcentered $ $ Cybersecurity: Secured authentication with proper hash storage \\
...
% {\textcolor{darkgray}{Co-Founder in Food Industry \newline
