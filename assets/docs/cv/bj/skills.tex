...
% }
\\
% | Stakeholder Management \& Alignment % \item
% | UX Optimization
...
%
In Progress % \\ %\setlength\itemsep{-0.3em}
% {\scriptsize
  \begin{itemize}
    \setlength\itemsep{-0.3em}
...
\item User Acquisition, User Engagement, %[MAU \& CSAT],
Conversion and Retention Rates % CSAT [Customer Satisfaction Score].
